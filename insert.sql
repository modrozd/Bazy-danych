...
INSERT INTO Lekarze (PESEL, Imie, Nazwisko, Plec, Data_urodzenia, Specjalizacja)
	...
	(61101567346, 'Ryszard', 'Ka³u¿ny', 'M', '1961-10-15', 'Reumatolog'),
...
INSERT INTO Pacjenci (PESEL, Imie, Nazwisko, Plec, Data_urodzenia, Numer_pracownika) -- Numer_pacjenta PK pomijam
	...
	(29022467892, 'Zdzis³aw', 'Beksiñski', 'M', '1929-02-24',	(SELECT dbo.Zwroc_nr_pracownika(55071551574))),
...
INSERT INTO Zabiegi_i_operacje (Nazwa, Zalecenia, ID_pobytu, Numer_pacjenta)
	...
	('Gastroskopia', 'Nie paliæ przez tydzieñ.',
				(SELECT ID_pobytu FROM Pobyty WHERE Numer_pacjenta IN (SELECT Numer_pacjenta from Pacjenci where PESEL = 90121003556)), (SELECT Numer_pacjenta from Pacjenci where PESEL = 90121003556)),
	('Biopsja prostaty', 'Kontrolowaæ stan zdrowia, w razie potrzeby kontaktowaæ siê z lekarzem rodzinnym.', 
	...
	('Kolonoskopia', 'Stosowaæ siê do zaleconej diety.', 
	...
	('Usuniêcie guza CUN', 'Przyjmowaæ zalecone leki.', 
	...
	('Termoablacja', 'Nie paliæ przez tydzieñ i przyjmowaæ zalecone leki.', 
	...
	('Appendektomia', 'Przyjmowaæ zalecone leki.', 
	...
	('Cholecystektomia', 'Skontaktowaæ siê z lekarzem rodzinnym po wypisaniu ze szpitala, nie stosowaæ u¿ywek.', 
	...
	('Histerektomia z przydatkami', 'Przyjmowaæ zalecone leki. W razie niepokoju kontaktowaæ siê z lekarzem rodzinnym.', 
	...
	('Gastroskopia', 'Przyjmowaæ zalecone leki.', 
	...
	('Craniotomia', 'Przyjmowaæ zalecone leki.', 
	...
	('Termoablacja', 'Przyjmowaæ zalecone leki.', 
	...
	('Termoablacja', 'Kontakt z lekarzem rodzinnym i nastêpna wizyta do ustalenia w rejestracji.', 
...
INSERT INTO Badania (Rezonans, Biopsja, CA_125, CEA, Numer_pacjenta)
	VALUES
		...
		('Krêgos³up w stanie fatalnym...', null, null, 43.0,
				(SELECT Numer_pacjenta from Pacjenci where PESEL = 53053056828)),
		(null, 'Wykonana biopsja wskazanego obszaru p³uc, œladowe iloœci komórek guzowych.', 59.0, 7.5,
				(SELECT Numer_pacjenta from Pacjenci where PESEL = 66011653642)),
		('Brak zmian', 'Wykryto zmianê nowotworow¹ o rozmiarze 3x2x1', 57.0, 6,
...
INSERT INTO Przebieg_leczenia (Rodzaj_leczenia, Zatrzymanie_sie_choroby, Remisja, Informacje_od_lekarza, Data_zgonu, Numer_pracownika, ID_pobytu, ID_diagnozy)
	...
	('Leczenie chirurgiczne', 0, 1, 'Pacjent zmar³ w wyniku powik³añ po operacji chirurgicznej.', '2020-11-09', (SELECT Numer_pracownika FROM Pacjenci WHERE PESEL = 53053056828), (SELECT ID_pobytu FROM Pobyty WHERE Numer_pacjenta IN (SELECT Numer_pacjenta FROM Pacjenci WHERE PESEL = 53053056828)), (SELECT ID_diagnozy FROM Posiadana_choroba WHERE Numer_pacjenta IN (SELECT Numer_pacjenta FROM Pacjenci WHERE PESEL = 53053056828))),
	('Leczenie chirurgiczne', 1, 0, 'Stosowane leczenie nie przynios³o efektów.', '2019-10-17',					(SELECT Numer_pracownika FROM Pacjenci WHERE PESEL = 66011653642), (SELECT ID_pobytu FROM Pobyty WHERE Numer_pacjenta IN (SELECT Numer_pacjenta FROM Pacjenci WHERE PESEL = 66011653642)), (SELECT ID_diagnozy FROM Posiadana_choroba WHERE Numer_pacjenta IN (SELECT Numer_pacjenta FROM Pacjenci WHERE PESEL = 66011653642))),
...
INSERT INTO Przyjmowane_leki (Data_rozpoczenia_przyjmowania, Data_zakonczenia_przyjmowania, Dawkowanie, Numer_pacjenta, Nazwa_leku, ID_leczenia)
	...
	('2020-12-12', null, 'Stosowaæ do odwolania.',			(SELECT Numer_pacjenta FROM Pacjenci WHERE PESEL = 66010102741), 'Lek3', (SELECT ID_leczenia FROM Przebieg_leczenia WHERE ID_diagnozy IN (SELECT ID_diagnozy FROM Posiadana_choroba WHERE Numer_pacjenta IN (SELECT Numer_pacjenta FROM Pacjenci WHERE PESEL = 66010102741)))),
